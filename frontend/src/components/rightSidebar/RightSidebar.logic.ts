...
export const getSummaryData = async():Promise<any> => {
  let url = 'http://192.168.80.106:5013/api/Device/devicesinfor';
      ...
      url = 'http://192.168.80.106:5013/api/Service/serviceinfor'
    ...
    url = 'http://192.168.80.106:5013/api/Assignment/statistic'
      response = await fetchWithTokenRetry(url);
      if (response.ok) {
